...
[![functions](https://img.shields.io/badge/functions_matched-1247_of_1461_(85.35%25)-blue)](#progress) [![bytes](https://img.shields.io/badge/code_bytes_resolved-588692_of_944340_(62.34%25)-blue)](#progress) [![names](https://img.shields.io/badge/symbols_named-1433_adopted-blue)](#progress)

| | Done | Total | |
| :--- | ---: | ---: | ---: |
| **Whole program** | 588,692 | 944,340 | **62.34%** |
| Resident C | 318,656 | 475,076 | 67.07% |
| Verified assembly | 17,184 | 475,076 | 3.62% |
| Overlay C | 252,852 | 469,264 | 53.88% |
| Functions matched | 1,247 | 1,461 | 85.35% |
| Names adopted | 1,339 | 1,461 | 91.65% |
...
**Source organization**: 712 fully-C translation units and 149 C scaffolds that still include assembly: 151 under `src/libultra/`; 63 under `src/main/`, including `matrix.c` (matrix/vector maths) and `runlink.c` (the runtime overlay linker core); 647 across 106 `src/overlays/oNNN/` directories (largest: `o101` 71, `o014` 28, `o011` 26, `o057` 24, `o084` 22).
