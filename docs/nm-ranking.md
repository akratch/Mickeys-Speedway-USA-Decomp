...
The snapshot contains **251 queued identities**: **251 resolved measurements** and **0 unresolved identities**. Resolved target size totals **341,800 bytes (333.8 KiB)**.
...
| 152 | `src/main/frontend_37D50.c` | `func_800371BC` | `main` | `size-mismatch` | 600 | 114 | 114 | 44 | 44 | 4 | — |
...
| 156 | `src/overlays/o054/overlay54Initialize.c` | `func_overlay_054_F0000000_189ECA0` | `o054` | `size-mismatch` | 972 | 142 | 125 | 84 | 240 | 4 | — |
