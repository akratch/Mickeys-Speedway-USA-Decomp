...
The snapshot contains **250 queued identities**: **250 resolved measurements** and **0 unresolved identities**. Resolved target size totals **341,164 bytes (333.2 KiB)**.
