...
The snapshot contains **250 queued identities**: **250 resolved measurements** and **0 unresolved identities**. Resolved target size totals **341,124 bytes (333.1 KiB)**.
...
| 19 | `src/main/objects.c` | `func_80006B04` | `main` | `other` | 316 | 6 | 6 | 32 | 32 | 0 | — |
| 20 | `src/overlays/o008/overlay_008.c` | `func_overlay_008_F0001000_185ED58` | `o008` | `other` | 660 | 12 | 7 | 188 | 188 | 0 | — |
...
| 24 | `src/overlays/o007/func_overlay_007_F0000324_185C1AC.c` | `func_overlay_007_F0000324_185C1AC` | `o007` | `other` | 1,392 | 19 | 10 | 132 | 288 | 0 | — |
| 25 | `src/overlays/o001/overlay_001.c` | `overlay1FindPreviousUsable` | `o001` | `other` | 160 | 14 | 12 | 4 | 20 | 0 | — |
| 26 | `src/main/frontend_37D50.c` | `func_80037414` | `main` | `other` | 580 | 13 | 13 | 52 | 52 | 0 | — |
...
| 47 | `src/main/lights.c` | `func_80018F08` | `main` | `other` | 820 | 41 | 41 | 32 | 32 | 0 | — |
| 48 | `src/overlays/o073/overlay73Draw.c` | `func_overlay_073_F0000D70_18CB830` | `o073` | `other` | 312 | 42 | 42 | 28 | 28 | 0 | — |
...
| 57 | `src/overlays/o040/overlay40BuildFrame.c` | `overlay40BuildFrame` | `o040` | `other` | 324 | 60 | 60 | 48 | 48 | 0 | — |
| 58 | `src/main/objects.c` | `func_8000BB84` | `main` | `other` | 260 | 61 | 61 | 0 | 0 | 0 | — |
| 59 | `src/main/shadows.c` | `func_800180B4` | `main` | `other` | 824 | 61 | 61 | 52 | 52 | 0 | — |
| 60 | `src/overlays/o037/overlay37Render.c` | `overlay37RenderEffect` | `o037` | `other` | 856 | 61 | 61 | 84 | 84 | 0 | — |
| 61 | `src/main/objects.c` | `func_8000831C` | `main` | `other` | 424 | 62 | 62 | 112 | 112 | 0 | — |
...
| 66 | `src/overlays/o083/overlay83DrawStrip.c` | `overlay83DrawStrip` | `o083` | `other` | 308 | 69 | 69 | 4 | 4 | 0 | — |
| 67 | `src/main/objects.c` | `func_80004FE0` | `main` | `other` | 1,384 | 70 | 70 | 308 | 308 | 0 | — |
...
| 70 | `src/overlays/o058/overlay58FinalizePackedStatus.c` | `overlay58FinalizePackedStatus` | `o058` | `other` | 1,216 | 76 | 75 | 24 | 24 | 0 | — |
| 71 | `src/overlays/o025/overlay_025.c` | `overlay25UpdateEffect` | `o025` | `other` | 1,036 | 76 | 76 | 60 | 60 | 0 | — |
| 72 | `src/overlays/o002/func_overlay_002_F0000C90_1857A88.c` | `func_overlay_002_F0000C90_1857A88` | `o002` | `other` | 1,420 | 90 | 76 | 152 | 220 | 0 | — |
...
| 75 | `src/overlays/o031/overlay31BuildLookupTables.c` | `func_overlay_031_F0000000_187F520` | `o031` | `other` | 744 | 86 | 86 | 52 | 52 | 0 | — |
| 76 | `src/overlays/o057/func_overlay_057_F0004E18_18A8A10.c` | `func_overlay_057_F0004E18_18A8A10` | `o057` | `other` | 4,832 | 155 | 86 | 132 | 256 | 0 | — |
...
| 81 | `src/overlays/o083/overlay83BuildBatch.c` | `overlay83BuildBatch` | `o083` | `other` | 672 | 98 | 98 | 0 | 0 | 0 | — |
| 82 | `src/main/anim.c` | `func_80051364` | `main` | `other` | 1,148 | 102 | 102 | 0 | 0 | 0 | — |
| 83 | `src/main/models.c` | `func_80020B10` | `main` | `other` | 636 | 102 | 102 | 12 | 12 | 0 | — |
| 84 | `src/main/weather_tail.c` | `func_8003C80C` | `main` | `other` | 472 | 103 | 103 | 20 | 20 | 0 | — |
| 85 | `src/overlays/o050/overlay50Initialize.c` | `func_overlay_050_F0000000_1896970` | `o050` | `other` | 740 | 112 | 104 | 60 | 192 | 0 | — |
| 86 | `src/main/font.c` | `func_8004C690` | `main` | `other` | 584 | 105 | 105 | 0 | 0 | 0 | — |
| 87 | `src/overlays/o101/overlay101TailC6E8.c` | `func_overlay_101_F000C6E8_18E7F08` | `o101` | `other` | 1,268 | 113 | 106 | 76 | 76 | 0 | — |
| 88 | `src/main/textures_354C8.c` | `func_800355A0` | `main` | `other` | 1,076 | 109 | 109 | 72 | 72 | 0 | — |
| 89 | `src/main/weather.c` | `rain_render_splashes` | `main` | `other` | 1,616 | 113 | 113 | 148 | 148 | 0 | — |
| 90 | `src/overlays/o052/overlay52Initialize.c` | `func_overlay_052_F0000000_189A670` | `o052` | `other` | 1,264 | 119 | 115 | 44 | 44 | 0 | — |
| 91 | `src/main/objects.c` | `func_8000B3CC` | `main` | `other` | 1,976 | 116 | 116 | 328 | 328 | 0 | — |
...
| 95 | `src/overlays/o101/overlay101BuildPresentationD.c` | `overlay101BuildPresentationD` | `o101` | `other` | 824 | 131 | 130 | 16 | 16 | 0 | — |
...
| 150 | `src/overlays/o089/overlay89UpdateStateAndParticles.c` | `overlay89UpdateStateAndParticles` | `o089` | `size-mismatch` | 544 | 85 | 85 | 8 | 8 | 4 | — |
| 151 | `src/main/matrix.c` | `func_8002AA50` | `main` | `size-mismatch` | 296 | 90 | 90 | 0 | 0 | 68 | — |
| 152 | `src/main/sched.c` | `func_80030610` | `main` | `size-mismatch` | 768 | 105 | 104 | 140 | 140 | 4 | — |
| 153 | `src/main/frontend_37D50.c` | `func_800371BC` | `main` | `size-mismatch` | 600 | 114 | 114 | 44 | 44 | 4 | — |
