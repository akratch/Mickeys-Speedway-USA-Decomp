...
| 132 | `src/overlays/o046/func_overlay_046_F0000874_188EC6C.c` | `func_overlay_046_F0000874_188EC6C` | `o046` | `size-mismatch` | 1,800 | 56 | 50 | 112 | 508 | 8 | — |
| 133 | `src/main/saves.c` | `func_8002CF6C` | `main` | `size-mismatch` | 352 | 54 | 54 | 32 | 32 | -8 | — |
...
| 147 | `src/main/font.c` | `func_8004C690` | `main` | `size-mismatch` | 584 | 105 | 105 | 0 | 0 | -8 | — |
| 148 | `src/main/track.c` | `func_8000D1B8` | `main` | `size-mismatch` | 512 | 114 | 114 | 48 | 48 | 8 | — |
...
| 151 | `src/overlays/o041/overlay41ProcessEntry.c` | `func_overlay_041_F0001464_188879C` | `o041` | `size-mismatch` | 492 | 120 | 120 | 16 | 16 | 20 | — |
| 152 | `src/main/fx.c` | `wakeDraw` | `main` | `size-mismatch` | 708 | 121 | 121 | 0 | 0 | -4 | — |
